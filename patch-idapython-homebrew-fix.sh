...
HOMEBREW_PYTHON="/usr/local/Cellar/python@3.8/3.8.6_1/Frameworks/Python.framework/Versions/3.8/Python"
...
PLG=${IDABIN}/plugins/idapython.dylib
PLG64=${IDABIN}/plugins/idapython64.dylib

# backup idapython plugin
backup ${PLG}
backup ${PLG64}

DYNLOAD=${IDABIN}/python/3
...
function patch
{
  # install_name_tool -change /Library/Developer/CommandLineTools/Library/Frameworks/Python3.framework/Versions/3.8/Python3 $HOMEBREW_PYTHON $1
